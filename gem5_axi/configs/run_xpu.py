...
p.add_argument('--bridge-impl',choices=['cpp','rtl'],default='cpp')
...
system.axi=AxiDemo(backend='aou',bridge_impl=a.bridge_impl,memory_backend='memsim',base=0x90000000,size=size,
